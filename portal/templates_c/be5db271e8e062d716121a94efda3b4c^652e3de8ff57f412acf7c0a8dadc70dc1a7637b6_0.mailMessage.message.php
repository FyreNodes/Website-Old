<?php
/* Smarty version 3.1.36, created on 2021-05-10 23:53:27
  from 'mailMessage:message' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_6099c777713cf1_41281989',
...
function content_6099c777713cf1_41281989 (Smarty_Internal_Template $_smarty_tpl) {
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                                <img src="https://dijxcloud.com/images/logo.png" style="max-width:600px;padding:20px 20px 0 20px" id="headerImage" alt="DijxCloud" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        <tr>
                                            <td valign="top" class="footerContent">
                                                ...
                                                &nbsp;<a href="https://dijxcloud.com/">https://dijxcloud.com/</a>
                                                <span class="hide-mobile"> | </span>
                                                <a href="https://dijxcloud.com/portal/admin/">log in to the admin area</a>&nbsp;
                                            </td>
                                        </tr>
                                    </table>
                                </td>
